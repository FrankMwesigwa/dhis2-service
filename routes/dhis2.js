...
async function fetchData() {
    const query = `
    SELECT dhis2_facility_id, facility, sub_county, district, period_date, hh_registered, hh_people, 
        vhts_submitted_report, vhts_expected_to_report, villages_reporting, u1_month_male, u1_month_female, 
        death_u1month_male, death_u1month_female, btn_1_11_months_male, btn_1_11_months_female, death_btn_1_11month_male, 
        death_btn_1_11month_female, btn_1_5_yrs_male, btn_1_5_yrs_female, death_btn_1_5yrs_male, death_btn_1_5yrs_female, 
        u5_yrs_male, u5_yrs_female, btn_5_17_yrs_male, btn_5_17_yrs_female, death_btn_5_17yrs_male, death_btn_5_17yrs_female, 
        btn_18_24_yrs_male, btn_18_24_yrs_female, btn_25_65_yrs_male, btn_25_65_yrs_female, death_btn_25_65yrs_male, 
        death_btn_25_65yrs_female, above_65_yrs_male, above_65_yrs_female, death_over_65yrs_male, death_over_65yrs_female, 
        num_vitamin_a_12_59months_male, num_vitamin_a_12_59months_female, num_dewormed_6_59months_male, 
        num_dewormed_6_59months_female, assesed_muac_12_59months_male, assesed_muac_12_59months_female, 
        yellow_muac_12_59months_male, yellow_muac_12_59months_female, red_muac_12_59months_male, red_muac_12_59months_female, 
        oedema_12_59months_male, oedema_12_59months_female, referred_with_oedema_yellred_muac_12_59months_male, 
        referred_with_oedema_yellred_muac_12_59months_female, oedema_yellred_muac_linked_12_59months_male, 
        oedema_yellred_muac_linked_12_59months_female, pregnant_lactating_muac_screened, pregnant_lactating_yellow_muac, 
        pregnant_lactating_red_muac, pregnant_women, num_pregnant_lactating_referred4yellow_red_muac, 
        pregnant_lactating_linked4yellow_red_muac, u5_immunization_upto_date_male, u5_immunization_upto_date_female, 
        deaf_male, deaf_female, lameness_male, lameness_female, difficulty_remembering_male, difficulty_remembering_female, 
        blindness_male, blindness_female, difficulty_communicating_male, difficulty_communicating_female, 
        difficulty_selfcare_male, difficulty_selfcare_female, hiv_positive_male, 
        hiv_positive_female, not_on_art_treatment_male, not_on_art_treatment_female, has_tb_male, 
        has_tb_female, not_on_tb_treatment_male, not_on_tb_treatment_female, using_fp_method_male, using_fp_method_female, 
        delivery_at_home, died_during_pregnancy, atleast_4_anc_visits, atleast_8_anc_visits, btn_10_24_yrs_male, 
        btn_10_24_yrs_female, adolescents_received_hpv_male, adolescents_received_hpv_female, adolescents_received_td_male, 
        adolescents_received_td_female, sleep_under_llin_male, sleep_under_llin_female, household_have_latrine,
         household_have_improved_latrine, household_functional_handwashing_facility, num_of_household_safe_water, 
         household_is_odf, u2months_attended_to_male, u2months_attended_to_female, u5_attended_to_male, u5_attended_to_female, 
         u5_diarrhea_male, u5_diarrhea_female, u5_diarrhea_treated_with_ors_male, u5_diarrhea_treated_with_ors_female, 
         u5_diarrhea_treated_24hrs_male, u5_diarrhea_treated_24hrs_female, u5_fever_male, u5_fever_female, 
         u5_with_fever_received_mrdt_male, u5_with_fever_received_mrdt_female, u5_mrdt_positive_male, 
         u5_mrdt_positive_female, u5_malaria_received_act_male, u5_malaria_received_act_female, 
         u5_fever_and_danger_signs_male, u5_fever_and_danger_signs_female, u5_fever_and_danger_sign_treated_with_rectal_male, 
         u5_fever_and_danger_sign_treated_with_rectal_female, u5_fever_treated_24hours_male, u5_fever_treated_24hours_female, 
         u5_with_pneumonia_male, u5_with_pneumonia_female, u5_pneumonia_received_amoxicillin_male, 
         u5_pneumonia_received_amoxicillin_female, u5_pneumonia_24hr_treatment_male, u5_pneumonia_24hr_treatment_female, 
         u5_managed_recovered_by_vht_male, u5_managed_recovered_by_vht_female, hiv_exposure_male, hiv_exposure_female, 
         suspected_tb_male, suspected_tb_female, pnc_atleast_2visits_male, pnc_atleast_2visits_female, sick_reffered_male, 
         sick_reffered_female, act_item_received, act_item_returned, act_given_iccm, zinc_item_received, zinc_item_returned, 
         zinc_given_iccm, amoxicillin_item_received, amoxicillin_item_returned, amoxicillin_given_iccm, 
         malaria_rdts_item_received, malaria_rdts_item_returned, malaria_rdts_given_iccm, pop_item_received, 
         pop_item_returned, pop_given_fp, dmpa_item_received, dmpa_item_returned, dmpa_given_fp, coc_item_received, 
         coc_item_returned, coc_given_fp, condoms_item_received, condoms_item_returned, condoms_given_fp, 
         contraceptives_item_received, contraceptives_item_returned, contraceptives_given_fp, rectal_item_received, 
         rectal_item_returned, rectal_given_iccm, gloves_item_received, gloves_item_returned, gloves_given_iccm
        FROM steward.dhis2_values;
    `;
    ...
    return rows.map(row => {
        return {
            ...
            dataValues: [
                ...
                { dataElement: "XbUmjB60oYJ", value: row.vhts_submitted_report },
                { dataElement: "oOFDcl8DThU", value: row.villages_reporting },
                { dataElement: "QHM8oVo4BFu", value: row.u2months_attended_to_male },
                { dataElement: "QMbYk1fYRaD", value: row.u2months_attended_to_female },
                { dataElement: "nG2UvgcdPCs", value: row.u5_diarrhea_male },
                { dataElement: "or2wkB8pXNa", value: row.u5_diarrhea_female },
                { dataElement: "r62xVwT5E1D", value: row.u5_diarrhea_treated_with_ors_male },
                { dataElement: "Ya78umVFGoA", value: row.u5_diarrhea_treated_with_ors_female },
                ...
                { dataElement: "WgRvzNrpu61", value: row.sick_reffered_male },
                { dataElement: "JkrAQg2cVc7", value: row.sick_reffered_female },
                { dataElement: "wozPliVW6dd", value: row.malaria_rdts_item_received },
                { dataElement: "dsjxSlajJhL", value: row.malaria_rdts_given_iccm },
                { dataElement: "BKbaOBwOYOX", value: row.malaria_rdts_item_returned },
                { dataElement: "s5FtDCNBH8y", value: row.amoxicillin_item_received },
                { dataElement: "RRTKR5IlJDs", value: row.amoxicillin_given_iccm },
                { dataElement: "GQnehOCvC4J", value: row.amoxicillin_item_returned },
                { dataElement: "cJm2qpsmczU", value: row.zinc_item_received },
                ...
                { dataElement: "cV2HGmPOS5G", value: row.assesed_muac_12_59months_male },
                { dataElement: "jwVM1ck5HO2", value: row.assesed_muac_12_59months_Female },
                { dataElement: "bhJ7czojmPK", value: row.yellow_muac_12_59months_Female },
                { dataElement: "nAMWBZME9MJ", value: row.yellow_muac_12_59months_female },
                { dataElement: "x6HhIGP1kaM", value: row.oedema_12_59months_Female },
                { dataElement: "SqiLy4Mkjq1", value: row.oedema_12_59months_female },
                { dataElement: "iw7Sm4Iv0jm", value: row.red_muac_12_59months_male },
                { dataElement: "muDxwt6Z7lV", value: row.red_muac_12_59months_female },
                { dataElement: "DAes9aO44NR", value: row.referred_with_oedema_yellred_muac_12_59months_male },
                { dataElement: "P8Qevaon3nY", value: row.referred_with_oedema_yellred_muac_12_59months_female },
                { dataElement: "CDAqQZOuzvk", value: row.oedema_yellred_muac_linked_12_59months_male },
                { dataElement: "cBnsyxZ5Wgi", value: row.oedema_yellred_muac_linked_12_59months_female },
                ...
                { dataElement: "Htspk4eFdtq", value: row.using_fp_method_male },
                { dataElement: "FxQEc2KNsUP", value: row.using_fp_method_female },
                { dataElement: "tnHBYgGljs2", value: row.delivery_at_home },
                { dataElement: "GIzTKtQV2ey", value: row.died_during_pregnancy },
                { dataElement: "hqlAIlGGx0j", value: row.atleast_4_anc_visits },
                { dataElement: "Tj0ofGGRQG4", value: row.atleast_8_anc_visits },
                { dataElement: "OtiHNSdSx8o", value: row.btn_10_24_yrs_male },
